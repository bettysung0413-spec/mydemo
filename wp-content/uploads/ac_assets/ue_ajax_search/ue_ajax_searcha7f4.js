function UEAjaxSearch(){
  ...
  */
  function handleResponse(response){
    ...
    var suggestionObj = getVal(response, "search_suggestion");
    var dataAutocorrect = g_objItemsWrapper.data('autocorrect');
    
    if(dataAutocorrect == true && htmlItems == "" && suggestionObj && suggestionObj.suggestion){
        
        var suggestion = suggestionObj.suggestion;
        var textBefore = g_objItemsWrapper.data('autocorrect-beforetext');;
        var textAfter = g_objItemsWrapper.data('autocorrect-aftertext');;
        
        htmlItems = "<div class='uc-ajax-search__suggested-item'>" + textBefore + "<a href='javascript:void(0)' class='uc-ajax-search__suggested-link'>" + suggestion + "</a>" + textAfter  + "</div>";
    }
  ...
  */ 
  function createPaginationElement(){
    ...
    var itemsNumber = g_objItemsWrapper.children().not(".uc-ajax-search__suggested-item").length - 1;
  ...
  */
  function initEvents(){    
    ...
    g_objWrapper.on('click', '.uc-ajax-search__suggested-link', onSuggestedLinkClick);
